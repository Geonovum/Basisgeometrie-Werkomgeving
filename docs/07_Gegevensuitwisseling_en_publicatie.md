...
De beschrijving van de respectivelijke EPSG codes zijn te vinden onder de url's met het format  ht<span>tp://</span>www.opengis.net/def/crs/EPSG/0/epsgcode. Bijvoorbeeld: http://www.opengis.net/def/crs/EPSG/0/28992
